#############################################################################
# Makefile for building: bitmillion-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Jan 8 16:14:52 2018
# Project:  Bitmillion-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Bitmillion-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Bitmillion/src/leveldb/libleveldb.a /tmp/Bitmillion/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		Bitmillion-qt.pro
QMAKE_TARGET  = bitmillion-qt
DESTDIR       = 
TARGET        = bitmillion-qt
...
Makefile: Bitmillion-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Bitmillion-qt.pro
...
/tmp/Bitmillion/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Bitmillion/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Bitmillion/build/build.h: FORCE
	cd /tmp/Bitmillion; /bin/sh share/genbuild.sh /tmp/Bitmillion/build/build.h
